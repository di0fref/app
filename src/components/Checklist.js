    ...
    return (
        ...
        <div className={'pl-2 mt-3'}>
            <div className="my-3 h-2 w-full bg-neutral-200 relative rounded">
                <div className={'absolute -left-9 -top-1 text-xs'}>{percentage}%</div>
        ...
        {!newItem && <button onClick={addItem} className={'bg-modal-dark hover:bg-modal-darker py-1 px-2 rounded-box ml-2 my-2 text-sm'}>Add
            item</button>}
    </div>)
}
