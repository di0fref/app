...
const SortableItem = SortableElement(({project, id}) => {
    ...
    return (
        <div className={` group py-0.5 dark:text-white hover:bg-hov dark:hover:bg-gray-900/30 rounded`}>
            <div className={'flex items-center'}>
                ...
                <Link to={"/project/" + project.id} className={'flex items-center flex-grow'}>
                    ...
                    <div className={'hover:text-gray-600 dark:hover:text-neutral-100 dark:text-neutral-300 text-gray-500 text-sm'}>{project.title}</div>
                </Link>
